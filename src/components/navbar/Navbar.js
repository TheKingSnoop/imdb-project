            ...
            <AppBar position='static'>
                <Toolbar>
                    <div className='navbar_container'>
                        ...
                        {/* Desktop Navigation */}
                        <Typography className="test" variant='h6' component="div" sx={{ flexGrow: 1, display: { xs: "none", md: "flex" } }}>SEEN IT</Typography>
                        <Box sx={{ display: { xs: "none", md: "flex" } }}>
                            <Stack direction='row' spacing={2}>
                                <Button variant="contained">SIGN IN</Button>
                                <Button variant="contained" color="secondary">DARK MODE</Button>
                            </Stack>
                        </Box>
                        {/* Mobile Navigation */}
